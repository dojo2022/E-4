...
public class CoordinateInsertModel implements Serializable{
	...
	public CoordinateInsertModel(String user_id, String coordinate_id, String season,
			String purpose, String coordinate_image) {
		super();
